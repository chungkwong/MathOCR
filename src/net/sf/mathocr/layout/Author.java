...
/**
 * A data structure representing author
 */
public final class Author extends TextLike{
	/**
	 * Construct a Author
	 ...
	 */
	public Author(String content,boolean noStart,boolean noEnd,int left,int right,int top,int bottom){
		super(content,noStart,noEnd,left,right,top,bottom);
	}
	/**
	 * Construct a Author containing a single text line
	 * @param line the text line
	 */
	public Author(TextLine line){
		super(line);
	}
