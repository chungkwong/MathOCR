...
/**
 * A data structure representing paragraph
 */
public final class Paragraph extends TextLike{
	/**
	 * Construct a Paragraph containing a single text line
	 ...
	 */
	public Paragraph(String content,boolean noStart,boolean noEnd,int left,int right,int top,int bottom){
