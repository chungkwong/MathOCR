...
public class FontTest{
	public static void testFontAlphanum(){
		...
		for(Font font:fonts){
			...
			for(int codePoint:codePoints){
				if(font.canDisplay(codePoint)){
					test.addSample(getComponent(font,codePoint),codePoint);
				}
			}
		}
		test.printResult();
