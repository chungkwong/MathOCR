 ...
 */
public class AspectRatio implements VectorFeature{
	public static final String NAME="ASPECT_RATIO";
	@Override
	public double[] extract(ConnectedComponent component){
		return new double[]{((double)component.getHeight())/component.getWidth()};
	}
	@Override
